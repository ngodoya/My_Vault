...
[[#Numerical Differentiation and Integration|Integral and Derivatives]]
# Optimization
...
but also, in my case this is impractical, the best idea it could be:
...
```
**Singular values measure how much independent information exists in each principal direction of the matrix.**
**The singular values tell us how much independent information the matrix contains along its principal directions. Small singular values indicate directions that contribute little new information.**
## 3. Interpolation
### Overview
...
**Polynomial form:** $$f_n(x)=b_0+b_1(x-x_0)+\dots+b_n(x-x_0)\dots(x-x_{n-1})$$
...
> Remember that there is another option for least squares.
...
You can check the official Presentation :D, click [[6. Numerical Differentiation and Integration.pdf]] 
...
## 2. Newton-Cotes Integration Formula
Repasando los conceptos clásicos del cálculo integral e diferencial, podemos utilizar métodos numéricos para solucionar solucionar integrales que no son tan sencillas de evaluar o integrar, recuerde librearias como ``scipy``
